...
public class Dictionary {
	...
	public static Map<Integer, String> mapaDiccionario = new TreeMap<Integer, String>();
	...
	public static String cargarPalabra() {
		...
		dc.cargarDiccionario();

		palabra += Dictionary.mapaDiccionario.get(random.nextInt(124));

		return palabra;
	}

	public static String cargarAlias() {
		...
		palabrasAlias.add(Dictionary.cargarPalabra());
